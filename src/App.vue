<template>
  <div class="app">
    ...
    <footer class="footer">
      <span class="footer-slogan">The hassle-free, offline time tracker.</span>
      <a href="https://github.com/andremissaglia/time-track-it" target="_blank" rel="noopener" aria-label="GitHub repository">
